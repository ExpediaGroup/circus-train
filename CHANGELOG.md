...
implicitly scanned and loaded but won't be now. Instead these extensions will now need to be added using Circus Train's (standard extension loading mechanism)[https://github.com/HotelsDotCom/circus-train#loading-extensions]. In particular this applies to the "reference" (AWS SNS event listener extension)[https://github.com/HotelsDotCom/circus-train/tree/master/circus-train-aws-sns]. 
