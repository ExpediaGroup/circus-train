...
public class BeekeeperHiveTableAnnotatorTest {
  ...
  private BeekeeperHiveTableAnnotator tableAnnotationService;
  ...
  public void init() throws TException {
    ...
    tableAnnotationService = new BeekeeperHiveTableAnnotator(closeableMetaStoreClientSupplier);
  }
  ...
  public void typical() throws TException {
    ...
    Map<String, String> parameters = tableArgumentCaptor.getValue()
      .getParameters();
    assertThat(parameters.get(BeekeeperHiveTableAnnotator.BEEKEEPER_PARAM_KEY), is("true"));
