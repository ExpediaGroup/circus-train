...
If the specific `avro-serde-options` configuration is not provided by the user, Circus Train will still copy the external schema to the target table in a `.schema` folder.
