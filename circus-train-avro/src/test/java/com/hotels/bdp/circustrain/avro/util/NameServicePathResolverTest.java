...
public class NameServicePathResolverTest {
  ...
  public void resolveNameServiceAddsAuthorityFromRootPath() {
    ...
    assertEquals("hdfs://hdp-ha/etl/test/avsc/schema.avsc",
        new NameServicePathResolver(configuration).resolve("hdfs:/etl/test/avsc/schema.avsc").toString());
  }
  ...
  public void resolveNameServiceAddsAuthorityFromPathWithoutScheme() {
    setDfsNameservices("hdp-ha");
    assertEquals("/hdp-ha/etl/test/avsc/schema.avsc",
        new NameServicePathResolver(configuration).resolve("/etl/test/avsc/schema.avsc").toString());
  }
