...
In particular notice that it is possible to nest sub-expressions within parentheses. Wild cards are a allowed in the form of `.*`, example: `year like '201.*'`. Full regular expressions don't seem to be supported by Hive. 
